...
import { Bot, Loader2, Plus, Trash2, GripVertical } from "lucide-react";
...
export function ProfileExperienceSection({
  ...
  reorderExperiences: (next: ProfileFormValues["experience"]) => void;
...
function ExperienceCard({
  ...
  item: ProfileFormValues["experience"][number];
  index: number;
  errors: FieldErrors<ProfileFormValues>;
  removeExperience: (index: number) => void;
  updateExperience: (index: number, key: string, value: string) => void;
